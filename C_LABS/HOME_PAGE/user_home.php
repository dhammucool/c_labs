...
if(isset($_SESSION['uname']))  //i.e. if session exist
{
$u=$_SESSION['uname'];
include "connect.php";
//echo "$u";

$qry="select name from new_user where name='$u'";
...
<head>
    ...
    <!-- Main stylesheet -->
    <link href='assets1/css/hallooou.css' rel='stylesheet'>
     
    <!-- Color stylesheet -->
    <!-- <link href='assets1/css/colors.css' rel='stylesheet'> -->
    <!-- <link href='assets1/css/colors_2.css' rel='stylesheet'> -->
    <!-- <link href='assets1/css/colors_3.css' rel='stylesheet'> -->
    <!-- <link href='assets1/css/colors_4.css' rel='stylesheet'> -->


    <!-- Plugin stylesheets -->
    <link href='assets1/css/plugins/owl.carousel.css' rel='stylesheet'>
    <link href='assets1/css/plugins/owl.theme.css' rel='stylesheet'>
    <link href='assets1/css/plugins/owl.transitions.css' rel='stylesheet'>
    <link href='assets1/css/plugins/animate.css' rel='stylesheet'>
    <link href='assets1/css/plugins/magnific-popup.css' rel='stylesheet'>
    <link href='assets1/css/plugins/jquery.mb.YTPlayer.min.css' rel='stylesheet'>
...
<body id='home'>
                ...
                <div class='container'>
                    <div class='navbar-header pull-left'>
                        <a class='navbar-brand page-scroll' href='#page-top'>
                            ...
                            <span class='brand-logo'><img src='assets1/images/logo.png' onerror='this.src='assets1/images/logo.png'; this.onerror=null;' alt='Hallooou - HTML5 Template' title='Hallooou - HTML5 Template' class='img-responsive'></span>
                        </a>
                    </div>
            ...
            <header id='intro-carousel' class='carousel slide'>
                ...
                <div class='carousel-inner'>
                    <div class='item active'>
                        ...
                        <div class='fill' style='background-image:url('assets1/images/cover-one.jpg');'></div>
                        <div class='carousel-caption'>
                        <font face='georgia' size='7' color='green'>$a</font>
                            <h1 class='wow animated slideInDown'>Taking your SECURITY <span class='highlight'>new heights</span></h1>
                            <p class='intro-text wow animated slideInUp'>We care is project that will take your place security to next level.</p>
                    ...
                    <div class='item'>
                        ...
                        <div class='fill' style='background-image:url('assets1/images/cover-two.jpg');'></div>
                        <div class='carousel-caption'>
                            <h1 class='wow animated slideInDown'><span class='highlight'>Responsive &amp; Retina</span> Ready</h1>
                            <p class='intro-text wow animated slideInUp'>A clean and bold HTML5 template, Hallooou is ultra responsive and retina ready.</p>
                            <a href='http://bit.ly/hh5_template' class='btn btn-default btn-lg'>Download theme</a>
                        </div>
                        <div class='overlay-detail'></div>
                    </div><!-- /.item -->
                    ...
                    <div class='item'>
                        <!-- Set the second background image using inline CSS below. -->
                        <div class='fill' style='background-image:url('assets1/images/cover-three.jpg');'></div>
                        <div class='carousel-caption'>
                            <h1 class='wow animated slideInDown'>Customizable <span class='highlight'>colors</span> &amp; blocks</h1>
            ...
            <section id='about' class='about content-section alt-bg-light wow fadeInUp' data-wow-offset='10'>
                <div class='container'>
                    <div class='row'>
                        ...
                        <div class='col-md-6'>
                            <!-- Display image -->
                            <!-- <img src='assets1/images/hallooou_template-iphone_sm.png' class='img-responsive'> -->
            ...
            <section id='products' class='products content-section'>
                <div class='container'>
                    <div class='row'>
                        <div class='col-md-4'>
                            <img src='assets1/images/hallooou_template-iphone_white.png' class='center-block img-responsive'>
                        </div><!-- /.col-md-4 -->
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-4'>
                                    <div class='team-member wow fadeIn' data-wow-offset='10'>
                                        <figure>
                                            <img src='assets1/images/lauren-cox.jpg' alt='' class='img-responsive'>
                                            <figcaption>
                                ...
                                <div class='col-md-4'>
                                    <div class='team-member wow fadeIn' data-wow-offset='10'>
                                        <figure>
                                            <img src='assets1/images/jessie-barnett.jpg' alt='' class='img-responsive'>
                                            <figcaption>
                                ...
                                <div class='col-md-4'>
                                    <div class='team-member wow fadeIn' data-wow-offset='10'>
                                        <figure>
                                            <img src='assets1/images/terry-fletcher.jpg' alt='' class='img-responsive'>
                                            <figcaption>
                ...
                <div class='container project-container text-center'>
                    <div class='recent-project-carousel owl-carousel owl-theme popup-gallery'>
                        <div class='item recent-project wow fadeIn' data-wow-offset='10'>
                            <img src='assets1/images/gallery/project-one.jpg' alt=''>
                            ...
                            <div class='full-project'>
                                <a href='assets1/images/gallery/project-one_xl.jpg' title='Lakeview Inc. | Website Design'>View project <i class='fa fa-chevron-right'></i></a>
                            </div><!-- /.full-project -->
                        </div><!-- /.item -->

                        <div class='item recent-project wow fadeIn' data-wow-offset='10'>
                            <img src='assets1/images/gallery/project-two.jpg' alt=''>
                            <div class='project-info'>
                            ...
                            <div class='full-project'>
                                <a href='assets1/images/gallery/project-two_xl.jpg' title='Adam Productions | App Design'>View project <i class='fa fa-chevron-right'></i></a>
                            </div><!-- /.full-project -->
                        </div><!-- /.item -->

                        <div class='item recent-project wow fadeIn' data-wow-offset='10'>
                            <img src='assets1/images/gallery/project-three.jpg' alt=''>
                            <div class='project-info'>
                            ...
                            <div class='full-project'>
                                <a href='assets1/images/gallery/project-three_xl.jpg' title='Doe Associates | Branding'>View project <i class='fa fa-chevron-right'></i></a>
                            </div><!-- /.full-project -->
                        </div><!-- /.item -->

                        <div class='item recent-project wow fadeIn' data-wow-offset='10'>
                            <img src='assets1/images/gallery/project-four.jpg' alt=''>
                            <div class='project-info'>
                            ...
                            <div class='full-project'>
                                <a href='assets1/images/gallery/project-four_xl.jpg' title='Omega Corporation | App Design'>View project <i class='fa fa-chevron-right'></i></a>
                            </div><!-- /.full-project -->
                        </div><!-- /.item -->
                ...
                <div class='container'>
                    ...
                    <div class='row client-slider'>
                        <div class='item col-xs-4 col-md-2 i'>
                            <a href='#' title='#'>
                                <img src='assets1/images/sony-logo.png' class='img-responsive'>
                            </a>
                        </div><!-- /.col-xs-4 -->

                        <div class='item col-xs-4 col-md-2 i'>
                            <a href='#' title='#'>
                                <img src='assets1/images/nike-logo.png' class='img-responsive'>
                            </a>
                        </div><!-- /.col-xs-4 -->

                        <div class='item col-xs-4 col-md-2 i'>
                            <a href='#' title='#'>
                                <img src='assets1/images/paramount-logo.png' class='img-responsive'>
                            </a>
                        </div><!-- /.col-xs-4 -->

                        <div class='item col-xs-4 col-md-2 i'>
                            <a href='#' title='#'>
                                <img src='assets1/images/microsoft-logo.png' class='img-responsive'>
                            </a>
                        </div><!-- /.col-xs-4 -->

                        <div class='item col-xs-4 col-md-2 i'>
                            <a href='#' title='#'>
                                <img src='assets1/images/citibank-logo.png' class='img-responsive'>
                            </a>
                        </div><!-- /.col-xs-4 -->

                        <div class='item col-xs-4 col-md-2 i'>
                            <a href='#' title='#'>
                                <img src='assets1/images/fedex-logo.png' class='img-responsive'>
                            </a>
                        </div><!-- /.col-xs-4 -->
                                    ...
                                    <div class='client-testimonials owl-carousel owl-theme'>
                                        ...
                                        <div class='item'>
                                            ...
                                            <div class='client-info'>
                                                <img src='assets1/images/gina_stone-client_pic.jpg' />
                                                <h4>Gina Stone</h4>
                                        ...
                                        <div class='item'>
                                            ...
                                            <div class='client-info'>
                                                <img src='assets1/images/john_doe-client_pic.jpg' />
                                                <h4>John Doe</h4>
                                        ...
                                        <div class='item'>
                                            ...
                                            <div class='client-info'>
                                                <img src='assets1/images/dana_hill-client_pic.jpg' />
                                                <h4>Dana Hill</h4>
                ...
                <div class='container'>
                    <div class='row text-center'>
                        ...
                        <div class='col-md-6 wow slideInRight' data-wow-offset='10'>
                            <img src='assets1/images/hallooou-responsive.png' class='img-responsive'>
                        </div><!-- /.col-md-6 -->
                ...
                <div class='container'>
                    <div class='row form-container'>
                        ...
                        <div class='col-md-8 contact-form'>
                            ...
                            <form class='ajax-form' id='contactForm' method='post' action='assets1/php/contact.php'>
                        ...
                        <div class='col-md-4 contact-address'>
                            <h3>Our address</h3>
                            <p><i class='fa fa-map-marker fa-fw'></i> 76 Ninth Ave,
                                <br />New York, NY 10011,
                                <br /> United States</p>
                            <ul>
                                <li><i class='fa fa-envelope fa-fw'></i>hello@hallooou.com</li>
                                <li><i class='fa fa-phone fa-fw'></i>+88 (0) 101 0000 000</li>
                            </ul>
                        </div><!-- /.contact-address -->
                    ...
                    <div class='row text-center'>
                        <div class='col-md-12 segment'>
                            <a href='#' title='Hallooou - HTML5 Template'>
                                <h2>
                                    <!-- replace with your brand logo/text -->
                                    <img src='assets1/images/logo.svg' onerror='this.src='assets1/images/logo.png'; this.onerror=null;' alt='Hallooou - HTML5 Template' title='Hallooou - HTML5 Template' class='img-responsive'>
                                </h2>
                            </a>
                    ...
                    <div class='container'>
                        <div class='row'>
                            <div class='col-md-12 text-center'>
                                &copy; 2015. Hallooou. All rights reserved.
                            </div><!-- /.col-md-12 -->
    ...
    <!-- Plugin JavaScript -->
    <script src='assets1/js/plugins/wow.min.js'></script>
    <script src='assets1/js/plugins/owl.carousel.min.js'></script>
    <script src='assets1/js/plugins/jquery.parallax-1.1.3.js'></script>
    <script src='assets1/js/plugins/jquery.magnific-popup.min.js'></script>
    <script src='assets1/js/plugins/jquery.mb.YTPlayer.min.js'></script>
    <script src='assets1/js/plugins/jquery.countTo.js'></script>
    <script src='assets1/js/plugins/jquery.inview.min.js'></script>
    <script src='assets1/js/plugins/pace.min.js'></script>
    <script src='assets1/js/plugins/jquery.easing.min.js'></script>
    <script src='assets1/js/plugins/jquery.validate.min.js'></script>
    <script src='assets1/js/plugins/additional-methods.min.js'></script> 
    <script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyBoVKfEihX__NdMwdDysA6Vve6PE9Ierj4'></script>

    <!-- Custom JavaScript -->
    <script src='assets1/js/hallooou.js'></script>
</body>
